...
nc_f = './caafc139-0722-45a8-8936-afe48a56092a_28_08_2023.nc'  # Your filename
nc_fid = Dataset(nc_f, 'r')  # Dataset is the class behavior to open the file
                             # and create an instance of the ncCDF4 class
nc_attrs, nc_dims, nc_vars = ncdump(nc_fid)
# Extract data from NetCDF file
lats = 50.0  #nc_fid.variables['lat'][:]  # extract/copy the data
lons = 18.0  #nc_fid.variables['lon'][:]
time = nc_fid.variables['time'][:]
air = nc_fid.variables['air_temperature'][:]  # shape is time, lat, lon as shown above
...
w_nc_fid.description = "NCEP/NCAR Reanalysis %s from its value at %s. %s" %\
                      (nc_fid.variables['air_temperature'].var_desc.lower(),\
...
w_nc_var.setncatts({'long_name': u"mean Daily Air temperature",\
                    ...
                    'statistic': u'Mean\nM'})
w_nc_fid.variables['air_temperature'][:] = air[time_idx, lat_idx, lon_idx]
